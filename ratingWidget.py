...
class IconLabel(QtWidgets.QLabel):
    ...
    mouse_enter_icon = QtCore.pyqtSignal(QtWidgets.QLabel)
    # Signal emitted when the mouse leaves the icon.
    mouse_leave_icon = QtCore.pyqtSignal(QtWidgets.QLabel)
    # Signal emitted when the mouse is released over an icon.
    mouse_release_icon = QtCore.pyqtSignal(QtWidgets.QLabel)
